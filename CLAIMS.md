...
**stable, conservative** reading of public claims. It matches the hygiene used in the
author's public record page and federal engagement language.
...
| This repository is the open architectural reference under CC BY 4.0 (text/docs) | [LICENSE](LICENSE), this repo |
| Runnable reference demos of audit-first and supervisory override | `examples/` |
...
| Materials **transmitted** to DOE Genesis Mission channels under **MILO-ES-2026-002** and **MILO-ES-2026-003-DOE** | Author records; public record page — **transmission only** |
